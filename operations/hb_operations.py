...
@singledispatch
def csr_subtraction_matrices_hb(matrix_1: list, matrix_2: list):
    ar, ia, ja = csr(matrix_1)
    if matrix_1 == matrix_2:
        br, ib, jb = ar, ia, ja
    else:
...
@csr_subtraction_matrices_hb.register
def _csr_subtraction_matrices_hb(file_name_1: str, file_name_2: str):
    matrix_1 = read_file(file_name=file_name_1, return_list=True)
    matrix_2 = read_file(file_name=file_name_2, return_list=True)
    ar, ia, ja = csr(matrix_1)
    if matrix_1 == matrix_2:
...
@singledispatch
def csc_addition_matrices_hb(matrix_1: list, matrix_2: list):
...
@csc_addition_matrices_hb.register
def _csc_addition_matrices_hb(file_name_1: str, file_name_2: str):
    matrix_1 = read_file(file_name=file_name_1, return_list=True)
    matrix_2 = read_file(file_name=file_name_2, return_list=True)
    ar, ia, ja = csc(matrix_1)
    if matrix_1 == matrix_2:
...
@singledispatch
def csc_subtraction_matrices_hb(matrix_1: list, matrix_2: list):
    ar, ia, ja = csc(matrix_1)
    if matrix_1 == matrix_2:
        br, ib, jb = ar, ia, ja
    else:
...
@csc_subtraction_matrices_hb.register
def _csc_subtraction_matrices_hb(file_name_1: str, file_name_2: str):
    matrix_1 = read_file(file_name=file_name_1, return_list=True)
    matrix_2 = read_file(file_name=file_name_2, return_list=True)
    ar, ia, ja = csc(matrix_1)
    if matrix_1 == matrix_2:
