...
@csr_addition_matrices_nxn.register
def _csr_addition_matrices_nxn(is_hb: bool, matrix: list, file_name: str):
    ar, ia, ja = csr(matrix)
    br, ib, jb = ar, ia, ja
...
# function for hb experiments
@csr_subtraction_matrices_nxn.register
def _csr_subtraction_matrices_nxn(is_hb: bool, matrix: list, file_name: str):
    ar, ia, ja = csr(matrix)
    br, ib, jb = ar, ia, ja
    start_time = time.time()
...
# function for hb experiments
@csc_addition_matrices_nxn.register
def _csc_addition_matrices_nxn(is_hb: bool, matrix: list, file_name: str):
    ar, ia, ja = csc(matrix)
    br, ib, jb = ar, ia, ja
    start_time = time.time()
...
# function for hb experiments
@csc_subtraction_matrices_nxn.register
def _csc_subtraction_matrices_nxn(is_hb: bool, matrix: list, file_name: str):
    ar, ia, ja = csc(matrix)
    br, ib, jb = ar, ia, ja
    start_time = time.time()
